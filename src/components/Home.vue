    ...
    <div id="content" :class="[{ 'no-animations': isLoading }, {'professional-mode': !radMode}]">
        ...
        <section class="data-driven" v-if="quotes" :class="{ 'hood-open': hoodOpen }">
            ...
            <div class="birdle carousel-item animate__animated" :class="dataCarouselClasses('birdle')">
                <RouterLink to="/birdle">
                    <figure>
                        <img src="../assets/images/no-image-icon.png" alt="Birdle preview image"/>
                    </figure>
                </RouterLink>
            </div>
...
<!--    @import url('https://fonts.googleapis.com/css2?family=Inter:ital,wght@100;300;400;500;600&family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;1,100;1,300;1,400;1,500&display=swap');-->
...
<!--    @import '../assets/scss/audio_player';-->

<!--    $glowColors: $neon, $andes, $purple, $blue;-->
...
<!--        display: grid;-->
<!--        grid: auto auto auto 1fr auto / 1fr 1fr;-->
...
<!--                align-self: start;-->
<!--                z-index: 2;-->
<!--                border: 2px solid #4ad4fe;-->
<!--                box-shadow: 0 0 1rem 0 #7e6ff9;-->
<!--                background-color: #7e6ff9;-->
...
<!--                grid-row: 2;-->
<!--                z-index: 4;-->
<!--                border: 4px solid lighten(#13B48B, 10%);-->
<!--                box-shadow: 0 0 .7rem 0 lighten(#13B48B, 20%);-->
...
<!--                box-shadow: 0 0 .7rem 0 rgba(255, 255, 255, .7);-->
<!--                border-radius: 3.3rem;-->
<!--                justify-self: end;-->
<!--                align-self: end;-->
<!--                animation-delay: .4s;-->
